...
def hour(use,name,unit):
    ...
    os.system("sudo chmod 777 "+path+"/Graphs/hour"+use+name+"Graph.png") #On modifie les permissions de l'image sauvegardée car dans le cas où on appelle cette fonction
    #depuis rfcomm-server, celui-ci étant restreint en permissions, l'image aussi et il sera donc impossible de l'afficher depuis l'interface
